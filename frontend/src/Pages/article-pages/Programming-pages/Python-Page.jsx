...
function PythonPage() {
    ...
    useEffect(() => {
        fetch("http://localhost:8000/api/posts/tag_lang/1/5/").then((res) => res.json()).then((data) => setLessons(data.data))
    },[])



    let threeArticles = <div className="row mt-3">
        <TopThree tag="tag_lang" name="5" section="1"/>
    ...
    let allArticles =    <div className="row mt-5">
            ...
            <AllPosts tag="tag_lang" name="5" section="1" />
    </div>
