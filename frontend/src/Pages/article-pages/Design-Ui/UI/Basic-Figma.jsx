...
function BasicFigma() {
    ...
    useEffect(() => {
        fetch("http://localhost:8000/api/posts/tag/7/").then((res) => res.json()).then((data) => setLessons(data.data))
    }, [])



    let threeArticles = <div className="row mt-3">
        <TopThree tag="tag" section="7" />
                ...
                <div className="container">
                    <div className="row mt-3 headOfAbout">
                        ...
                        <div
                            ...
                            style={{ display: "flex", alignItems: "center" }}
                        >
                            <p className="whous ">Basic Figma</p>
                        </div>
                    </div>
